...
public class Node extends SimpleScriptable {
    ...
    public ScriptResult fireEvent(final Event event) {
    	String atk_ind = "";
        return fireEvent(this, event,atk_ind);
    }

    public ScriptResult fireEvent(final Event event, String atk_ind) {
    	return fireEvent(this, event, atk_ind);
    }
    ...
    public static ScriptResult fireEvent(final SimpleScriptable scriptable, final Event event){
    	return fireEvent(scriptable, event, "");
    }
    
    public static ScriptResult fireEvent(final SimpleScriptable scriptable, final Event event, String atk_ind) {
        ...
        try {
            ...
            while (node != null) {
                ...
                final EventListenersContainer elc = jsNode.eventListenersContainer_;
                if ((atk_ind!=null) && (elc!=null) && (atk_ind!="")) {
                	elc.atk_ind = atk_ind;
                }
                if (elc != null) {
