...
import static net.sourceforge.htmlunit.corejs.classfile.ClassFileWriter.ACC_FINAL;
import static net.sourceforge.htmlunit.corejs.classfile.ClassFileWriter.ACC_PRIVATE;
import static net.sourceforge.htmlunit.corejs.classfile.ClassFileWriter.ACC_PUBLIC;
import static net.sourceforge.htmlunit.corejs.classfile.ClassFileWriter.ACC_STATIC;
import static net.sourceforge.htmlunit.corejs.classfile.ClassFileWriter.ACC_VOLATILE;
...
class BodyCodegen
{
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Lnet/sourceforge/htmlunit/corejs/javascript/Context;"
                +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                +"Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;"
                +"[Ljava/lang/Object;"
                +")Lnet/sourceforge/htmlunit/corejs/javascript/Scriptable;",
