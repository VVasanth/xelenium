...
public class ScriptRuntime {
                                                       ...
                                                       boolean sealed)
    {
        ...
        new LazilyLoadedCtor(scope, "RegExp",
                "net.sourceforge.htmlunit.corejs.javascript.regexp.NativeRegExp", sealed, true);
        new LazilyLoadedCtor(scope, "Packages",
                "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "getClass",
                "net.sourceforge.htmlunit.corejs.javascript.NativeJavaTopPackage", sealed, true);
        new LazilyLoadedCtor(scope, "JavaAdapter",
                "net.sourceforge.htmlunit.corejs.javascript.JavaAdapter", sealed, true);
        new LazilyLoadedCtor(scope, "JavaImporter",
                "net.sourceforge.htmlunit.corejs.javascript.ImporterTopLevel", sealed, true);
        new LazilyLoadedCtor(scope, "Continuation",
                "net.sourceforge.htmlunit.corejs.javascript.NativeContinuation", sealed, true);
